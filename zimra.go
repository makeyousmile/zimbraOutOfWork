...
func sendToZimbra(acc Acc, message string, fromdate string, todate string) {
	...
	xml := `<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope"><soap:Header><context xmlns="urn:zimbra"><userAgent xmlns="" name="ZimbraWebClient - FF126 (Win)" version="8.8.15_GA_4156"/><session xmlns="" id="1503980"/><account xmlns="" by="name">` + acc.Login + `@ft.by</account><format xmlns="" type="js"/><csrfToken xmlns="">` + TOKEN + `</csrfToken></context></soap:Header><soap:Body><BatchRequest xmlns="urn:zimbra" onerror="stop"><NoOpRequest xmlns="urn:zimbraMail" requestId="0"/><ModifyPrefsRequest xmlns="urn:zimbraAccount" requestId="1"><pref xmlns="" name="zimbraPrefOutOfOfficeFromDate">` + fromdate + `</pref><pref xmlns="" name="zimbraPrefOutOfOfficeReplyEnabled">TRUE</pref><pref xmlns="" name="zimbraPrefOutOfOfficeReply">` + message + `</pref><pref xmlns="" name="zimbraPrefOutOfOfficeUntilDate">` + todate + `</pref></ModifyPrefsRequest></BatchRequest></soap:Body></soap:Envelope>`
